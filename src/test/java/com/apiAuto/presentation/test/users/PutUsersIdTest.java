...
public class PutUsersIdTest {
    ...
    class PositiveTests {
        @Test
        @DisplayName("Case 4.1: Редактирование пользователя")
        void userUpdate() {
            ...
            given(requestSpec())
                    ...
                    .body(matchesJsonSchemaInClasspath("schemas/presentation/userCrudSchema/userUpdateSchema.json"));
        }
    }
    ...
    class NegativeTests {
        @Test
        @DisplayName("Case 4.1: Редактирование  пользователя при введенном некорректном Email")
